 ...
 */
final class Version20210128120118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lead_tags (id INT AUTO_INCREMENT NOT NULL, lead_id INT UNSIGNED DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_8E4AD1FC55458D (lead_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
